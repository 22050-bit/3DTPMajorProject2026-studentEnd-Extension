...
the program should be scanning for. then when it is spotted, the program will send a, not nesscarality loud, but definitely obvious notification for the teacher to press a yes or no or defer button. 

The sheet should automatically backup itself into many other sheet as time passes. Everyday the entries will be backed up to a seperate sheet. At the end of every month, the backup will be deleted, treated as cache.
